...
const groups = computed(() => [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'sdn-vpc',    label: t('nav.items.sdn_vpc.label'),    desc: t('nav.items.sdn_vpc.desc'),    icon: 'sdn' },
...
const Icons = {
  ...
  sdn:      'M4 7h6v6H4zM14 4h6v6h-6zM14 14h6v6h-6zM10 10l4-3M10 10l4 7M7 13v4',
