# review-report-process Specification Deltas (v242-3container-review)

> 本 change 在 [review-report-process](../../../../specs/review-report-process/spec.md) 之上 ADDED：
> 3 容器 + 双 qa + ops-toolkit 成熟度 review 报告制度。
