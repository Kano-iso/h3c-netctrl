...
**所有 12 个脚本默认指向 Test-Switch-177 (192.168.100.177)**：
...
- 过滤 ANSI 转义字符（terminal escape）
- 去掉命令回显（第一行）和末尾 prompt
- 仅打印真正的 display 输出
